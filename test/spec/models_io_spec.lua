...
describe("models_io", function()
  ...
  describe("get_models_from_cli", function()
    it("should call safe_shell_command with the correct arguments", function()
      ...
      assert.spy(mock_llm_cli.run_llm_command).was.called_with("models list --json")
    end)
  end)
  ...
  describe("get_default_model_from_cli", function()
    it("should call safe_shell_command with the correct arguments", function()
      ...
      assert.spy(mock_llm_cli.run_llm_command).was.called_with("models default")
    end)
  end)
  ...
  describe("set_default_model_in_cli", function()
    it("should call safe_shell_command with the correct arguments", function()
      ...
      assert.spy(mock_llm_cli.run_llm_command).was.called_with("models default gpt-3.5-turbo")
    end)
  end)
  ...
  describe("get_aliases_from_cli", function()
    it("should call safe_shell_command with the correct arguments", function()
      ...
      assert.spy(mock_llm_cli.run_llm_command).was.called_with("aliases list --json")
    end)
  end)
  ...
  describe("set_alias_in_cli", function()
    it("should call safe_shell_command with the correct arguments", function()
      ...
      assert.spy(mock_llm_cli.run_llm_command).was.called_with("aliases set alias1 model1")
    end)
  end)
  ...
  describe("remove_alias_in_cli", function()
    it("should call safe_shell_command with the correct arguments", function()
      ...
      assert.spy(mock_llm_cli.run_llm_command).was.called_with("aliases remove alias1")
    end)
  end)
end)

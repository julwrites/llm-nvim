...
describe("schemas_manager", function()
  ...
  describe("get_schemas", function()
    it("should return the loaded schemas", function()
      local fake_schemas = { { name = "schema1" }, { name = "schema2" } }
  ...
  describe("delete_schema", function()
    it("should call delete on the schema", function()
        local fake_schema = { name = "schema1", delete = require('luassert.spy').create() }
  ...
  describe("alias_schema", function()

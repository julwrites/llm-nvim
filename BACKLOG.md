...
## Ranked Backlog
1. [Gap 2] - [Medium Impact/Low Effort] - Missing support for explicit API Key override in prompt command (`--key TEXT`).
2. [Gap 3] - [Medium Impact/Low Effort] - Missing support for showing options for the selected model (`--options`).
3. [Gap 4] - [Medium Impact/Low Effort] - Missing support for no-log/log options (`-n, --no-log`, `--log`).

...
function M.load_models()
  llm_cli.run_llm_command_async('models list', function(models_output)
...
function M.load_available_plugins()
  llm_cli.run_llm_command_async('plugins --all', function(plugins_output)
...
function M.load_keys()
  llm_cli.run_llm_command_async('keys list', function(keys_output)
    if keys_output then
      local keys = {}
...
function M.load_fragments()
  llm_cli.run_llm_command_async('fragments list', function(fragments_output)
...
function M.load_templates()
  llm_cli.run_llm_command_async('templates list', function(templates_output)
...
function M.load_schemas()
  llm_cli.run_llm_command_async('schemas list', function(schemas_output)
